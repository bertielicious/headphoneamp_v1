...
#include <xc.h>
#include <stdbool.h>
#define _XTAL_FREQ 8000000      // internal clock freq 8MHz
...
#define SWIP PORTCbits.RC0      // pin 16 rotary encoder awitch

//****************************************************************
//****************states for menu defined*************************
#define CHOOSE_INPUT 1
#define INPUT_SELECTED 2
#define SET_VOL 3
#define HI 1
#define LO 0
#define ON 1        // used in bouncy.c
#define OFF 0
#define BOUNCE_ON 2
#define BOUNCE_OFF 3
...
//enum status {low, high}; // low = 0, high = 1
//enum status voltage;     // voltage is a variable of type state
...
#define MUTE_NOT_PUSHED 1
#define MUTE_PUSHED_BOUNCING 2
#define MUTE_PUSHED_STABLE 3
#define MUTE_RELEASED_BOUNCING 4
#define VOL 0
#define MUTE 1
#define SELECT_MUTE 2
#define SELECT_VOL 3
...
//bool position = HI;
volatile uchar previous_state;
volatile uchar current_state;
